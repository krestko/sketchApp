...
import NameSelectors from '../components/NameSelectors';
import ColorSelectors from '../components/ColorSelectors';
import SizeSelectors from '../components/SizeSelectors';
import ShapeSelectors from '../components/ShapeSelectors';
import PaddingSelectors from '../components/PaddingSelectors';
import TextSelectors from '../components/TextSelectors';
import FontSelectors from '../components/FontSelectors';
import BorderSelectors from '../components/BorderSelectors';
import ShadowSelectors from '../components/ShadowSelectors';
import '../App.css';
